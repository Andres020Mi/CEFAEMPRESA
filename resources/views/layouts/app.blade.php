...
<head>
    ...
    <meta name="description"
        content="CEFAEMPRESA - Sistema Integrado de Gestión Empresarial y Formación Agroindustrial en el Centro La Angostura, SENA. Explora nuestros servicios y productos sostenibles.">
    <!-- Keywords for SEO (optional, but can help with some search engines) -->
    <meta name="keywords"
        content="CEFAEMPRESA, SENA Empresa, agroindustrial, formación, gestión empresarial, Centro La Angostura, productos sostenibles, Huila">
    ...
    <meta property="og:description"
        content="Sistema Integrado de Control Empresarial y Formación Agroindustrial del SENA La Angostura. Conoce nuestros servicios y productos sostenibles.">
    ...
    <meta name="twitter:description"
        content="Plataforma oficial de CEFAEMPRESA - Gestión y formación agroindustrial en el Centro La Angostura.">
    ...
    <nav class="glass p-4 shadow-lg fixed top-0 w-full z-50">
        <div class="container mx-auto flex justify-between items-center">
            ...
            <div class="flex items-center space-x-2">
                <img src="{{ asset('img/logoCEFAEMPRESA.png') }}" alt="Logo {{ $keyword->word }}"
                    class="w-12 h-12 object-contain">
                <a href="/"
                    class="text-xl sm:text-xl md:text-3xl font-extrabold text-orange-300 tracking-tight">{{ $keyword->word }}</a>
            </div>
            ...
            <!-- Menú -->
            <div id="menu"
                class="hidden md:flex md:items-center md:space-x-6 absolute md:static top-16 left-0 w-full md:w-auto bg-gray-900 md:bg-transparent p-4 md:p-0 transition-all duration-300 ease-in-out z-50">
                <!-- Enlaces principales -->
                <div class="flex flex-col md:flex-row md:space-x-6">
                    <a href="/"
                        class="text-lg font-semibold text-white hover:text-orange-300 transition duration-300 block md:inline py-2 md:py-0">Inicio</a>
                    <a href="/nosotros"
                        class="text-lg font-semibold text-white hover:text-orange-300 transition duration-300 block md:inline py-2 md:py-0">Nosotros</a>
                    <a href="/productos"
                        class="text-lg font-semibold text-white hover:text-orange-300 transition duration-300 block md:inline py-2 md:py-0">Productos</a>
                    <a href="/formacion"
                        class="text-lg font-semibold text-white hover:text-orange-300 transition duration-300 block md:inline py-2 md:py-0">Formación</a>
                    <a href="/blog"
                        class="text-lg font-semibold text-white hover:text-orange-300 transition duration-300 block md:inline py-2 md:py-0">Blog</a>
                    <a href="/contacto"
                        class="text-lg font-semibold text-white hover:text-orange-300 transition duration-300 block md:inline py-2 md:py-0">Contacto</a>
                </div>
                ...
                @auth
                    ...
                    <div class="relative ml-auto md:ml-8">
                        <button id="user-menu-toggle"
                            class="flex items-center space-x-2 text-lg font-semibold text-white hover:text-orange-300 transition duration-300 py-2 md:py-0 focus:outline-none">
                ...
                @else
                    <a href="{{ route('login') }}"
                        class="ml-auto text-lg font-semibold text-orange-300 border border-orange-300 hover:bg-orange-300 hover:text-gray-900 transition duration-300 block md:inline py-2 px-4 rounded-full md:py-1">Log
                        in</a>
    ...
    <footer class="bg-gray-900 text-white p-8 mt-16">
        <div class="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <p class="text-gray-400">Sistema Integrado de Control Empresarial y de Formación Agroindustrial del SENA
                    La Angostura.</p>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="#"
                            class="text-gray-400 hover:text-orange-300 transition duration-300">SofíaPlus</a></li>
                    <li><a href="#"
                            class="text-gray-400 hover:text-orange-300 transition duration-300">Territorium</a></li>
                    <li><a href="#" class="text-gray-400 hover:text-orange-300 transition duration-300">Sistema de
                            Bibliotecas</a></li>
                    <li><a href="#" class="text-gray-400 hover:text-orange-300 transition duration-300">Agencia
                            Pública de Empleo</a></li>
                </ul>
            </div>
            <!-- Sección de Contacto -->
            <div>
                ...
                <p class="text-gray-400 pt-2 flex items-center gap-2">
                    ...
                    <a href="mailto:gerentesenaempresa2023@gmail.com"
                        class="text-gray-400 hover:text-orange-300 transition duration-300 break-all">gerentesenaempresa2023@gmail.com</a>
                </p>
                <p class="text-gray-400 pt-2 flex items-center gap-2">
            ...
            <div>
                ...
                <div class="flex space-x-4">
                    <a href="https://www.youtube.com/@gerenciasenaempresa9888" target="_blank"
                        rel="noopener noreferrer" class="text-gray-400 hover:text-orange-300 transition duration-300">
                        <i class="fab fa-youtube text-2xl"></i>
                    </a>
                    <a href="https://instagram.com/sena.empresa?igshid=MzNlNGNkZWQ4Mg==" target="_blank"
                        rel="noopener noreferrer" class="text-gray-400 hover:text-orange-300 transition duration-300">
                        <i class="fab fa-instagram text-2xl"></i>
                    </a>
                    <a href="[ENLACE_TIKTOK]" target="_blank" rel="noopener noreferrer"
                        class="text-gray-400 hover:text-orange-300 transition duration-300">
                        <i class="fab fa-tiktok text-2xl"></i>
                    </a>
                    <a href="https://www.facebook.com/profile.php?id=100014602595454" target="_blank"
                        rel="noopener noreferrer" class="text-gray-400 hover:text-orange-300 transition duration-300">
                        <i class="fab fa-facebook text-2xl"></i>
                    </a>
                </div>
                <!-- Redes Sociales RadioCefa -->
                <div class="mt-6">
                    <h3 class="text-xl font-bold text-orange-300 mb-4">Radio Cefa</h3>
                    ...
                    <div class="flex flex-col items-start space-y-4">
                        ...
                        <div class="flex space-x-6">
                            ...
                            <a href="https://www.tiktok.com/@radio.cefa?_t=ZS-900Dp5ZCYPC&_r=1" target="_blank"
                                rel="noopener noreferrer" class="text-gray-400 hover:text-orange-300 transition duration-300">
                                <i class="fab fa-tiktok text-2xl"></i>
                            </a>
                            <a href="https://www.facebook.com/share/16qSuPpAm1/" target="_blank"
                                rel="noopener noreferrer" class="text-gray-400 hover:text-orange-300 transition duration-300">
                                <i class="fab fa-facebook text-2xl"></i>
                            </a>
                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.addEventListener('click', function(event) {
                if (!menu.contains(event.target) && !toggleButton.contains(event.target) && !menu.classList
                    .contains('hidden')) {
            ...
            if (userMenuToggle && userMenu) {
                userMenuToggle.addEventListener('click', function() {
                    ...
                    console.log('Dropdown toggled:', userMenu.classList.contains('hidden') ? 'Oculto' :
                        'Visible');
                });
